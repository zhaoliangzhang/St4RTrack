...
class BaseStereoViewDataset (EasyDataset):
    ...
    def __init__(self, *,  
        ...
        super().__init__(curriculum_learning=curriculum_learning)
        self.num_views = 2
        self.split = split
    ...
    def __getitem__(self, idx):
        # jump to get_views() of each child dataset
        ...
        for v, view in enumerate(views):
            ...
            B = view['img'].shape[0]
            view['true_shape'] = np.tile(np.array([height, width]), (B, 1)).astype(np.int32)
...
def is_good_type(key, v):
    ...
    """
    if isinstance(v, (str, int, tuple, list)):
        return True, None
